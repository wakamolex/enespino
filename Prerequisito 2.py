...
recipiente1 = (recipiente1*0.05) + recipiente1
...
#porque = es para asignar un valor a una variable y el == sirve para compara 2 valores
...
name_length = len(nombre + seg_nombre + apellido)# como asi????
...
print("Hello {var1} {var2}".format(var1 = "Python", var2 = "Rules"))
...
diccio = {'Panama':5.9, 'Costa Rica':6.2, 'Colombia':8.4, 'Mexico':1.2}
print(diccio)

diccionario2 = {'Panama':8, 'Los Santos':7, 'Herrera':6, 'Colon':3}
#print(diccionario2['Veraguas'])
